...
<header class="sticky top-0 z-50 bg-[var(--warm-white)] border-b border-[var(--border)]">
    <div class="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-8">
            ...
            <a class="text-sm font-medium flex items-center gap-1.5 text-[var(--amber-dark)] hover:text-[var(--amber)] transition-colors"
                href="/course">Course <span
                    class="bg-[var(--amber-pale)] text-[var(--amber-dark)] text-[9px] uppercase font-bold px-1.5 py-0.5 rounded border border-[var(--amber-light)] mt-0.5 tracking-wider hidden lg:inline-block">New</span></a>
            <a class="text-sm font-medium text-[var(--ink-light)] hover:text-[var(--amber)] transition-colors"
